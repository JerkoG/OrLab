...
const config = {
    authRequired: false,
    auth0Logout: true,
    secret: 'fddfb3e0178f78d55cf397f63d2b30cee242d81400ee555633c679d644427b83',
    baseURL: 'http://localhost:3000',
    clientID: 'q0fDHvaBCHG5qJm8UMAHoE85zly0qr7M',
    issuerBaseURL: 'https://dev-d0mc3oo02wh1yvgi.us.auth0.com'
};
...
app.get('/api/automobili', async (req, res) => {
    ...
    try {
        ...
        const jsonLdData = rows.map(car => ({
            "@context": "https://schema.org",
            "@type": "Car",
            "schema:brand": car.marka,
            "schema:model": car.model,
        }));
        res.json({ originalData: rows, jsonLdData: jsonLdData });
    } catch (err) {
